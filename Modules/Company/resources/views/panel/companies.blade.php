                ...
                <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                    <div class="widget-content widget-content-area br-6">
                        <div class="row justify-content-between mx-0 align-items-center">
                            <h4>لیست شرکت ها</h4>
                            <a href="{{ route('panel.company.companiesCreate') }}" class="btn btn-primary "> <i class="fa fa-user-plus mr-1"></i><span >ثبت شرکت</span>
                            </a>
                        </div>
...
@section('js')
    ...
    <script>
        $('#companiesTable').DataTable( {
            ...
            processing: true,
            ajax:{
                url: "{{ route('panel.company.getCompanies') }}",
                dataType: "json",
                type: "POST",
