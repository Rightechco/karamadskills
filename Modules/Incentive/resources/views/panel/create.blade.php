            ...
            <div class="card-box">
                <div class="col-xl-12 col-lg-12 col-sm-12">
                    <div class="widget-content widget-content-area br-6">
                        ...
                        <div class="mb-4 mt-4">
                            <form id="form" action="{{ route('panel.incentive.incentiveStore') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="col-12 row mx-0 justify-content-between my-2">
                                    <div class="text-danger">تنها یک مشوق می توانید ثبت کنید، اگر چندین مدرک دارید با زدن دکمه افزودن، تمامی مدارک و مهارت های خود را اضافه کنید</div>
                                ...
                                <div class="border row mt-1 mb-4 p-2 p-lg-4" style="border-radius: .25rem">
                                    <div class="col-12 col-ms-6 col-lg-6 my-1">
                                        ...
                                        <input name="name[]" type="text" class="form-control" id="name" placeholder="نام دوره" value="">
                                        @error('name.*')
                                    ...
                                    <div class="col-12 col-ms-6 col-lg-6 my-1">
                                        ...
                                        <input name="time[]" type="text" class="form-control" oninput="fixInput(this)" id="time" placeholder="زمان به ساعت" value="">
                                        @error('time.*')
                                        <small class="form-text text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                    <div class="col-12 col-ms-6 col-lg-6 my-1">
                                        ...
                                        <input name="location[]" type="text" class="form-control" id="location" placeholder="مثلا دانشگاه مغان" value="">
                                        @error('location.*')
                                        <small class="form-text text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-12 col-ms-6 col-lg-6 my-1">
                                        ...
                                        <select class="form-control select2" id="type" name="type[]">
                                            ...
                                            <option value="1">مهارت های تخصصی</option>
                                            <option value="2">مهارت های شغلی عمومی</option>
                                            <option value="3">سابقه دستیار پژوهشی</option>
                                            <option value="4">سابقه دستیار آزمایشگاهی , کارآموزی , انجام امور کارگاهی , کارورزی</option>
                                            <option value="5">سابقه تدریس دروس دانشگاهی و دوره های تخصصی</option>
                                            <option value="6">دروس عملی و آزمایشگاهی و کارگاهی هر رشته</option>
                                        </select>
                                        @error('type.*')
                                        <small class="form-text text-danger">{{ $message }}</small>
                                        @enderror
                                    ...
                                    <div class="col-12 col-ms-6 col-lg-6 my-1">
                                        ...
                                        <input name="unit[]" type="text" class="form-control" id="unit" oninput="fixInput(this)" placeholder="فقط عدد وارد کنید" value="">
                                        @error('unit.*')
                                        <small class="form-text text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
