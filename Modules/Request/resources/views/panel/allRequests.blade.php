...
@section('content')
                ...
                <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
                    <div class="widget-content widget-content-area br-6">
                        <div class="row justify-content-between mx-0 align-items-center">
                            <h4>لیست درخواست های دریافتی</h4>
                        </div>
    ...
    <div class="modal fade" id="createBBB" tabindex="-1" role="dialog" aria-labelledby="createBBBModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form action="{{ route('panel.request.createMeet') }}" method="post">
                    @csrf
                    <div class="modal-body">
                        ...
                        <p><i class="mdi mdi-alert mr-2 text-danger" style="font-size: 20px"></i>هزینه ایجاد هر جلسه {{ number_format(config('tests.requestMeet')) }} می باشد</p>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-danger" data-dismiss="modal">انصراف</button>
                        <button type="submit" class="btn btn-primary">پرداخت و ایجاد جلسه</button>
                    </div>
                </form>
            </div>
        </div>
...
@section('js')
    ...
    <script>
        ...
        $('#companiesTable').DataTable( {
            ...
            processing: true,
            ajax:{
                url: "{{ route('panel.request.getAllRequests') }}",
                dataType: "json",
                type: "POST",
