...
@section('title','درخواست های شغلی')
@section('meta')
                ...
                <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
                    <div class="widget-content widget-content-area br-6">
                        <div class="row justify-content-between mx-0 align-items-center">
                            <h4>لیست درخواست های شغلی شما</h4>
                        </div>
                        <div class="table-responsive mb-4 mt-4">
                            <table id="companiesTable" class="table table-hover non-hover panel-table" style="width:100%">
                                ...
                                <tr>
                                    ...
                                    <th class="no-sort">عنوان آگهی</th>
                                    <th class="no-sort">نام شرکت</th>
                                    <th class="no-sort">شهر</th>
                                    <th class="no-sort">مصاحبه آنلاین</th>
                                </tr>
                                </thead>
                                <tbody>
                                </tbody>
...
@section('js')
    ...
    <script>
        $('#companiesTable').DataTable( {
            ...
            processing: true,
            ajax:{
                url: "{{ route('panel.request.getRequests') }}",
                dataType: "json",
                type: "POST",
