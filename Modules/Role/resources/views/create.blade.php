            ...
            <div class="card-box">
                <div class="col-xl-12 col-lg-12 col-sm-12">
                    <div class="widget-content widget-content-area br-6">
                        ...
                        <div class="mb-4 mt-4">
                            <form action="{{ route('panel.role.rolesStore') }}" method="post">
                                @csrf
                                        ...
                                        <div class="col-12 my-1 row">
                                            ...
                                            <div class="col-6 p-0 d-flex">
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input" id="permission{{ $permission->id }}" name="permissions[{{ $permission->slug }}]" value="{{ $permission->id }}">
