                ...
                <div class="col-xl-12 col-lg-12 col-sm-12">
                    <div class="widget-content widget-content-area br-6">
                        <div class="row justify-content-between mx-0 align-items-center">
                            <h4>لیست نقش ها</h4>
                            <a href="{{ route('panel.role.rolesCreate') }}" class="btn btn-primary "> <i class="fa fa-user-plus mr-1"></i><span >ثبت  نقش جدید </span>
                            </a>
                        </div>
                        <div class="table-responsive mb-4 mt-4">
                            <table id="rolesTable" class="table table-hover non-hover panel-table" style="width:100%">
                                <thead>
                                <tr>
                                    <th id="clickElement">کد</th>
                                    <th>نام</th>
                                    <th>اسلاگ</th>
                                    <th class="no-sort">دسترسی ها</th>
