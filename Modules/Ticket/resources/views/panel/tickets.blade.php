                ...
                <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
                    <div class="widget-content widget-content-area br-6">
                        <div class="row justify-content-between mx-0 align-items-center">
                            <div><h4>لیست پیام ها</h4></div>
                            <a href="{{ route("panel.ticket.send",'admin') }}" class="btn btn-outline-info" style="font-size: 16px">ارسال تیکت</a>
                        </div>
...
@section('js')
    ...
    <script>
        $('#companiesTable').DataTable( {
            ...
            processing: true,
            ajax:{
                url: "{{ route('panel.ticket.getTickets') }}",
                dataType: "json",
                type: "POST",
