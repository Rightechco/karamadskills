            ...
            <div class="card-box">
                <div class="col-xl-12 col-lg-12 col-sm-12">
                    <div class="widget-content widget-content-area br-6">
                        ...
                        <div class="mb-4 mt-4">
                            <form id="form" action="{{ route('panel.visit.visitUpdate',$visit->id) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="border row mt-1 mb-4 p-2 p-lg-4" style="border-radius: .25rem">
                                    <div class="col-12 col-ms-6 col-lg-6 my-1">
                                        ...
                                        <input required name="name" type="text" id="name" class="form-control" placeholder="نام" value="{{ old('name',$visit->name) }}">
                                        @error('name')
                                        ...
                                        <select class="form-control select2" id="university_id" name="university_id">
                                            ...
                                            @foreach ($universities as $university)
                                                <option @if (old('university_id',$visit->university_id) == $university['id']) selected @endif
                                        ...
                                        <input name="videoLink" type="text" id="videoLink" class="form-control" placeholder="آدرس ویدیو" value="{{ old('videoLink',$visit->videoLink) }}">
                                        @error('videoLink')
                                        <small class="form-text text-danger">{{ $message }}</small>
                                        @enderror
                                        ...
                                        @if(auth()->user()->can('VisitPermission'))
                                            <div class="col-12 col-ms-12 col-lg-12 my-1">
                                                ...
                                                <select class="form-control select2" data-live-search="true" id="status"
                                                    ...
                                                    @foreach(\Modules\Visit\Models\Visit::$statuses as $status)
                                                        <option @if($visit->status == $status) selected @endif value="{{ $status }}">{{ __('messages.'.$status) }}</option>
                                                    @endforeach
                                                </select>
                                                @error('status')
                                                <small id="sh-text1" class="form-text text-danger">{{ $message }}</small>
                                    ...
                                    <div class="col-12 col-ms-6 col-lg-6 my-1">
                                        ...
                                        <input name="slug" type="text" class="form-control" id="slug" placeholder="اسلاگ" value="{{ old('slug',$visit->slug) }}">
                                        @error('slug')
                                        <small class="form-text text-danger">{{ $message }}</small>
                                        @enderror
                                        ...
                                        @enderror
                                        @if($visit->image)
                                            <img class="mt-3 w-100" src="{{ asset($visit->image['indexArray'][$visit->image['currentImage']]) }}" alt="">
                                        @endif
                                ...
                                <div class="border row mt-1 mb-4 p-2 p-lg-4" style="border-radius: .25rem">
                                    <div class="col-12 col-ms-6 col-lg-6">
                                        ...
                                        <textarea class="col-12" id="expert" name="expert">{{ old('expert',$visit->expert) }}</textarea>
                                        @error('expert')
                                        <small id="sh-text1" class="form-text text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                    <div class="col-12 col-ms-6 col-lg-6">
                                        ...
                                        <textarea class="col-12" id="des" name="des">{{ old('des',$visit->des) }}</textarea>
                                        @error('des')
                                        <small id="sh-text1" class="form-text text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                    <div class="col-12 mt-3">
                                        ...
                                        <input type="hidden" name="tags" value="{{ old('tags',$visit->tags) }}" id="tags">
