                ...
                <div class="col-xl-12 col-lg-12 col-sm-12">
                    <div class="widget-content widget-content-area br-6">
                        ...
                        <div class="table-responsive mb-4 mt-4">
                            <table id="cardsTable" class="table table-hover non-hover panel-table" style="width:100%">
                                <thead>
                                <tr>
                                    <th id="clickElement">کد</th>
                                    <th class="">شماره کاربری</th>
                                    <th class="">شماره شبا</th>
                                    <th class="">شماره کارت</th>
                                    <th>کارت به نام</th>
                                    <th class="">کارت پیش فرض</th>
                                    <th class="">تاریخ ثبت کارت</th>
                                    <th class="">وضعیت</th>
